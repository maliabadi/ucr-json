/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 02764
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1997
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 02764-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1997 , Part 0001"

#delimit ;
label define STUDYNO   2764 "ICPSR Study No" ;
label define EDITION   1 "1st ed, August 1999" ;
