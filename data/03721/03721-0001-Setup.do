/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 03721
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 2001
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 03721-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 2001 , Part 0001"

#delimit ;
label define STUDYNO   3721 "ICPSR Study No" ;
label define EDITION   1 "1st ed, July 2003" ;
