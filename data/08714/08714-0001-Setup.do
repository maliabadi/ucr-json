/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 08714
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |              COUNTY LEVEL ARREST AND OFFENSES DATA, 1984
 |                     (DATASET 0001:  ARREST, 1984)
 |
 |                                                                        
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 08714-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY LEVEL ARREST AND OFFENSES DATA, 1984 , Part 0001"

#delimit ;
label define V7        9999999 "MISSING" ;
label define V8        9999999 "MISSING" ;
label define V9        999999 "MISSING" ;
label define V10       99999 "MISSING" ;
label define V11       99999 "MISSING" ;
label define V12       9999 "MISSING" ;
label define V13       9999 "MISSING" ;
label define V14       99999 "MISSING" ;
label define V15       99999 "MISSING" ;
label define V16       99999 "MISSING" ;
label define V17       99999 "MISSING" ;
label define V18       99999 "MISSING" ;
label define V19       9999 "MISSING" ;
