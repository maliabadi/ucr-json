/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 09573
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1989
 |                (DATASET 0001:  ARRESTS, ALL AGES, 1989)
 |
 |                                                                        
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 09573-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1989 , Part 0001"
...
replace V49 = . if (V49 == 9999)
replace V50 = . if (V50 == 999999)
replace V51 = . if (V51 == 9999)
replace V52 = . if (V52 == 9999)
