/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 06669
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1994
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 06669-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1994 , Part 0001"

#delimit ;
label define STUDYNO   6669 "ICPSR Study No" ;
label define EDITION   1 "1st ed, Jan 1997" ;
