/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 02910
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1998
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 02910-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1998 , Part 0001"

#delimit ;
label define STUDYNO   2910 "ICPSR Study No" ;
label define EDITION   1 "1st ed, June 2000" ;
