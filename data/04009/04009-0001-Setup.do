/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 04009
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 2002
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 04009-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 2002 , Part 0001"

#delimit ;
label define STUDYNO   4009 "ICPSR Study No" ;
label define EDITION   1 "1st ed, August 2004" ;
