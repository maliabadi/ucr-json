/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 02389
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1996
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 02389-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1996 , Part 0001"

#delimit ;
label define STUDYNO   2389 "ICPSR Study No" ;
label define EDITION   1 "1st ed, June 1998" ;
