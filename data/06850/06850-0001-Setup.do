/**************************************************************************
 |                    STATA SETUP FILE FOR ICPSR 06850
 |         UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]:
 |          COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1995
 ...
 |       - the dictionary file                                            
 |                                                                        
 |  Then execute the do file (e.g., do 06850-0001-statasetup.do)          
 |                                                                        
 **************************************************************************/
...
label data "UNIFORM CRIME REPORTING PROGRAM DATA [UNITED STATES]: COUNTY-LEVEL DETAILED ARREST AND OFFENSE DATA, 1995 , Part 0001"

#delimit ;
label define STUDYNO   6850 "ICPSR Study No" ;
label define EDITION   1 "1st ed, May 1997" ;
